...
NIBBA_STRINGS = [
    "`Abe nibbe`",
    "`Tu sala madarchod`",
    "`Tu bsdk mere lund par`",
    "`Ye nibba gandu hai`",
    "`Ye gand marwa kar manega`",
]
...
ABUSE_STRINGS = [
    ...
    "`mml`",
    "`You MotherFucker`",
    "`Chup ho jaa bosdiwale`" "`You Betichod`",
    "`You are lodu no.1`",
...
@userge.on_cmd("bc$", about=".bc For Maaki")
...
@userge.on_cmd("gey$", about=".gey for geys")
...
@userge.on_cmd("aaloo$", about=".aaloo for Potato sar - Thank you, Bhanchod")
